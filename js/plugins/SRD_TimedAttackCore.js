...
(function(_) {
	...
	if(Imported.YEP_BattleEngineCore) {
		...
		BattleManager.updatePhase = function() {
			...
			if(!this._action.item().meta.isUsingTimedAttackActionSequences &&
				...
				if(this[_.pass + "Allow TAS"][1]) {
					...
					if ((this._action.item().meta["SRD TAS"] && this._action.item().meta["SRD TAS"].type === "actor") ||
					...
					} else if ((this._action.item().meta["SRD TAS"] && this._action.item().meta["SRD TAS"].type === "class") ||
					...
					} else if ((this._action.item().meta["SRD TAS"] && this._action.item().meta["SRD TAS"].type === "weapon") ||
				...
				if(this._subject.isActor() && !this[_.pass + "Boolean 1"]) {
					...
					this._logWindow.startAction(this[_.pass + "Temp Subject"],
		...
		BattleManager.updateAction = function() {
			...
			if(this.checkIfTASActionAllowed() &&
				(this._action.item().meta["SRD TAS"] || _.notDefault()) &&
				this[_.pass + "Allow TAS"][0]) {
